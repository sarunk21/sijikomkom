        ...
        <div class="card-body">
            <form action="{{ route('admin.template-master.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="tipe_template" id="tipe_template"
                                ...
                                <option value="" disabled selected>Pilih Tipe Template...</option>
                                @foreach($tipeTemplateOptions as $value => $label)
                                    <option value="{{ $value }}" {{ old('tipe_template') == $value ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="template_file" class="form-label">File Template (.docx) <span class="text-danger">*</span></label>
                            ...
                            <small class="form-text text-muted">Format: .docx, Maksimal 10MB</small>
                            @error('template_file')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="ttd_file" class="form-label">File TTD Digital (opsional)</label>
