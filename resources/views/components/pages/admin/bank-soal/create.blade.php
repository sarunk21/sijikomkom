            ...
            <div class="col-lg-8">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Form Upload Bank Soal</h6>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.bank-soal.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('keterangan') is-invalid @enderror"
                                    ...
                                    placeholder="Tambahkan keterangan atau catatan jika diperlukan">{{ old('keterangan') }}</textarea>
                                @error('keterangan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
            ...
            <div class="col-lg-4">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="font-weight-bold mt-3">Perbedaan Tipe:</h6>
                        <ul class="small pl-3">
                            <li class="mb-2"><strong>FR IA 03:</strong> Asesmen awal / mandiri</li>
                            <li class="mb-2"><strong>FR IA 06:</strong> Praktik / uji kompetensi</li>
                            <li class="mb-2"><strong>FR IA 07:</strong> Observasi oleh asesor</li>
                        </ul>
                    </div>
                </div>
            </div>
