                        ...
                        <div class="card-body">
                            <div class="form-group mb-3">
                                ...
                                <textarea name="answers[{{ $form->id }}]" id="answer_{{ $form->id }}"
                                    ...
                                    placeholder="Tulis jawaban Anda di sini..." required>{{ old('answers.' . $form->id) ?? optional($form->responses->where('pendaftaran_id', $pendaftaran->id)->first())->answer_text }}</textarea>
